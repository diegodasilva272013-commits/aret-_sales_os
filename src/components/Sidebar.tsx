  ...
  return (
    <aside className="w-64 flex flex-col h-full shrink-0 animate-slide-in" style={{ background: "var(--surface)", borderRight: "1px solid var(--border)" }}>
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        {[
          { href: "/agent", label: "Agente LinkedIn", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="10" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1"/></svg> },
          { href: "/agent/logs", label: "Logs de Actividad", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> },
        ].map(item => {
